...
import (
	...
	"github.com/JokingLove/market-services/proto/market"
)

func (ms *MarketRpcService) GetSupportAssert(ctx context.Context, in *market.SupportAssertRequest) (*market.SupportAssertResponse, error) {
	return &market.SupportAssertResponse{
		ReturnCode: 100,
...
func (ms *MarketRpcService) GetMarketPrice(ctx context.Context, in *market.MarketPriceRequest) (*market.MarketPriceResponse, error) {
	...
	return &market.MarketPriceResponse{
		...
		MarketPrices:     marketPriceReturns,
